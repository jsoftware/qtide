...
$HOME/Qt/5.2.0/5.2.0/android_armv5/bin/androiddeployqt --ant true --input $N-$A.json --output ${INSTALL_ROOT} --deployment bundled --android-platform ${ANDROID_PLATFORM} --release -verbose
